...
object SimpleBannerHelper {
    ...
    //设置图片链接
    fun load(imageUrlList: ArrayList<String>): SimpleBannerHelper {
    ...
    //设置banner的点击事件
    fun onClick(onClick: (position: Int) -> Unit): SimpleBannerHelper {
        mOnClick = onClick
        return this
    }

    //设置图片的ScaleType
    fun setScaleType(imageScaleType: ImageView.ScaleType): SimpleBannerHelper {
